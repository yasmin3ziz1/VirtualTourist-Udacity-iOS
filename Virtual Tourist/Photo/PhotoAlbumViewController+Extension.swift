...
extension PhotoAlbumViewController: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    //To remove image that show in collection images
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        let refreshAlert = UIAlertController(title: "Remove Selected Pictur", message: "Are you sure to remove this ?", preferredStyle: UIAlertController.Style.alert)
